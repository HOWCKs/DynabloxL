...
class AppSettings(context: Context) {
    ...
    /** Material vocabulary: machined instrument or pressed clay. */
    enum class SurfaceFinish { MACHINED, CLAY }
    ...
    /**
     * Surface finish. CLAY is the default: it is the identity of the product, and the machined
     * finish stays available because dense instrument readouts are marginally sharper under it.
     */
    var surfaceFinish: SurfaceFinish
        get() = enum(KEY_FINISH, SurfaceFinish.CLAY)
        set(value) = commit { putString(KEY_FINISH, value.name) }
    ...
    companion object {
        ...
        private const val KEY_FINISH = "surface_finish"
