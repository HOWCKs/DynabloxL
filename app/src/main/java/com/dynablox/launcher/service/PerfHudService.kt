    ...
    private fun observeSettings() {
        ...
        observeJob = scope.launch {
            container.settings.changes.collect {
                ...
                // A theme/finish swap changes the style resource behind the view's themed context,
                // and a ContextThemeWrapper cannot be re-pointed — the window has to be rebuilt.
                val signature = SkeuoTheme.signature(this@PerfHudService, container.settings)
