...
dependencies {
    // Everything visual is drawn by the in-house design system (Canvas + custom widgets), so the
    // dependency set stays minimal: appcompat for the activities, core for notifications and
    // ContextCompat, lifecycle-runtime for lifecycleScope, activity for the permission contracts.
